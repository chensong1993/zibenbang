...
public class KDJDrawing implements IDrawing {
    ...
    public void onInit(RectF contentRect, AbstractRender render) {
        ...
        kPaint.setStrokeWidth(chartConfigs.getKdjLineSize());
        dPaint.setStrokeWidth(chartConfigs.getKdjLineSize());
        jPaint.setStrokeWidth(chartConfigs.getKdjLineSize());

        kPaint.setColor(chartConfigs.getKdjKLineColor());
        dPaint.setColor(chartConfigs.getKdjDLineColor());
        jPaint.setColor(chartConfigs.getKdjJLineColor());
