...
public class BOLLDrawing implements IDrawing{
    ...
    public void onInit(RectF contentRect, AbstractRender render) {
        ...
        r1Paint.setStrokeWidth(chartConfigs.getBollLineSize());
        r2Paint.setStrokeWidth(chartConfigs.getBollLineSize());
        r3Paint.setStrokeWidth(chartConfigs.getBollLineSize());

        r1Paint.setColor(chartConfigs.getBollMidLineColor());
        r2Paint.setColor(chartConfigs.getBollUpperLineColor());
        r3Paint.setColor(chartConfigs.getBollLowerLineColor());
