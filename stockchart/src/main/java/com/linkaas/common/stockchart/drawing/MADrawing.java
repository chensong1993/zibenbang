...
public class MADrawing implements IDrawing {
    ...
    public void onInit(RectF contentRect, AbstractRender render) {
        ...
        ma5Paint.setStrokeWidth(chartConfigs.getMaLineSize());
        ma10Paint.setStrokeWidth(chartConfigs.getMaLineSize());
        ma20Paint.setStrokeWidth(chartConfigs.getMaLineSize());

        ma5Paint.setColor(chartConfigs.getMa5Color());
        ma10Paint.setColor(chartConfigs.getMa10Color());
        ma20Paint.setColor(chartConfigs.getMa20Color());
