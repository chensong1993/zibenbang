...
public class RSIDrawing implements IDrawing {
    ...
    public void onInit(RectF contentRect, AbstractRender render) {
        ...
        r1Paint.setStrokeWidth(chartConfigs.getRsiLineSize());
        r2Paint.setStrokeWidth(chartConfigs.getRsiLineSize());
        r3Paint.setStrokeWidth(chartConfigs.getRsiLineSize());

        r1Paint.setColor(chartConfigs.getRsi1LineColor());
        r2Paint.setColor(chartConfigs.getRsi2LineColor());
        r3Paint.setColor(chartConfigs.getRsi3LineColor());
