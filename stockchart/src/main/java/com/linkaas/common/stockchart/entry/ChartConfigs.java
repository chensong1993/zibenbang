...
public class ChartConfigs {
    ...
    private float highlightSize = 1; // 高亮线条大小
    ...
    private float markerTextSize = 2; // MarkerView 字符大小
    ...
    private int avgLineColor = 0x78ffc004;
    private int breatheColor = 0xaa418288;
    private int fillColor = 0xaae3efff;
    ...
    private float shadowSize = 2f; // 影线大小
    ...
    public void setAvgLineColor(int avgLineColor) {
