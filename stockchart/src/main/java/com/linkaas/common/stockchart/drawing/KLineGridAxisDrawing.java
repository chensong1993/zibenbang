...
public class KLineGridAxisDrawing implements IDrawing {
    ...
    public void onComputeOver(Canvas canvas, int minIndex, int maxIndex, float minY, float maxY) {
        ...
        canvas.save();
        canvas.clipRect(kLineRect.left, kLineRect.top, kLineRect.right, kLineRect.bottom + chartConfigs.getXLabelViewHeight());
        ...
        for (int i = minIndex; i < maxIndex; i++) {
            ...
            if (i % count == 0) {
                ...
                canvas.drawText(
                        ...
                        pointCache[0],
                        kLineRect.bottom + render.getChartConfigs().getXLabelSize(),
                        xLabelPaint);
