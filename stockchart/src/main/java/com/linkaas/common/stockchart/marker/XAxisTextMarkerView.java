...
package com.linkaas.common.stockchart.marker;
...
public class XAxisTextMarkerView implements IMarkerView {
    ...
    public void onInitMarkerView(RectF contentRect, AbstractRender render) {
        ...
        markerTextPaint.setColor(chartConfigs.getMarkerTextColor());
        markerTextPaint.setTextSize(chartConfigs.getMarkerTextSize());
        ...
        markerBorderPaint.setStrokeWidth(chartConfigs.getMarkerBorderSize());
        markerBorderPaint.setColor(chartConfigs.getMarkerBorderColor());
        inset = markerBorderPaint.getStrokeWidth() / 2;

        xMarkerAlign = chartConfigs.getXMarkerAlign();
    }
