package com.zhiyi.chinaipo.ui.widget.recycleviewdivider;
 ...
 * recycleview GridLayoutManager的分割线
 */
public class RecycleviewGDivider extends RecyclerView.ItemDecoration {
        ...
        public RecycleviewGDivider(int space) {
            this.space = space;
        }

        public RecycleviewGDivider(int space, int color) {
            this.space = space;
            this.color = color;
        ...
        public RecycleviewGDivider(int space, int color,int type) {
            this.space = space;
            this.color = color;
            mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            mPaint.setColor(color);
        ...
        public RecycleviewGDivider(int space, Drawable mDivider) {
            this.space = space;
        ...
        private void drawGrideview(Canvas canvas, RecyclerView parent) {
            ...
            for (int i = 0; i < childSize; i++) {
                ...
                if (i != spancount) {
                    ...
                    linearLayoutManager.getSpanCount();
                }
            }
        }
