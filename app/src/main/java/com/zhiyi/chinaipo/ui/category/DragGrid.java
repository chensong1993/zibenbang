...
public class DragGrid extends GridView {
	...
	EnterEditModeListener listener;
	...
	//	mVibrator = (Vibrator) context.getSystemService(Context.VIBRATOR_SERVICE);
		...
		mVerticalSpacing = DeviceUtil.dip2px(context, mVerticalSpacing);
	}
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
	...
	public interface EnterEditModeListener {
		void doSth();
	}

	public void setOnEnterEditModeListener(EnterEditModeListener listener) {
