...
public class CircleProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        circleColor = typeArr.getColor(R.styleable.CircleProgressView_circleColor, getResources().getColor(R.color.hui1));
        circleProgressColor = typeArr.getColor(R.styleable.CircleProgressView_circleProgressColor, getResources().getColor(R.color.white));
        textColor = typeArr.getColor(R.styleable.CircleProgressView_textColor, getResources().getColor(R.color.white));
        textSize = typeArr.getDimension(R.styleable.CircleProgressView_textSize, getResources().getDimension(R.dimen.abc_text_size_caption_material));
