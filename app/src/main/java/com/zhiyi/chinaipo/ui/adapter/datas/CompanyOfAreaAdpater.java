...
public class CompanyOfAreaAdpater extends RecyclerView.Adapter<CompanyOfAreaAdpater.ListViewHolder> {

    private List<StasAreaEntity> mList;
    private Context mContext;

    public CompanyOfAreaAdpater(List<StasAreaEntity> dataList, Context context) {
        this.mList = dataList;
        this.mContext = context;
    }

    @Override
    public CompanyOfAreaAdpater.ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_data_annular, parent, false);
        return new ListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CompanyOfAreaAdpater.ListViewHolder holder, int position) {
        ...
        if (position == 5) {
            ...
            holder.tvNumber.setText(mList.get(position).getArea_name());
    ...
    public class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setItem(StasAreaEntity dataItem) {
